...
?>
    ...
    <body>
        <div class="container">
            ...
            <div class="box">
                <div class="notifyroom">
                    <div class="notifybox dislike">
                        <div class="b">
                            <p>your post rech 432 dislikes</p>
                        </div>
                    </div>
                    <div class="notifybox like">
                        <div class="b">
                            <p>your post rech 2432 likes</p>
                        </div>
                    </div>
                    <div class="notifybox comment">
                        <div class="b">
                            <p>your post rech 22 comments</p>
                        </div>
                    </div>
