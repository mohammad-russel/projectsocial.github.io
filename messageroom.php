    ...
    <body>
        <div class="container">
            ...
            <div class=" box">
                <?php
                include "php/config.php";
                $sql1 = "SELECT * FROM user  WHERE NOT mail = '{$useremail}'";
                ...
                ?>
                    <div class="peopleroom">
                        ...
                        ?>
                            <a style="text-decoration: none;" href="message.php?mid=<?php echo $row1['id'] ?>">
                                <div style="background:rgb(27, 97, 86) ;" class="peoplebox">
                                    <img src="userimage/<?php echo $row1['propic'] ?>" alt="">
                                    <h3><?php echo $row1['fname'] ?> <?php echo $row1['lname'] ?></h3>
                                </div>
                            </a>
                        <?php } ?>
                    </div>
